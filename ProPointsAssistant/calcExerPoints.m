...
#import "calcExerPoints.h"
#import "commonFunctions.h"

@interface calcExerPoints ()

@end

@implementation calcExerPoints {
    commonFunctions *cf;
    int iIntensity;
...
//Imperial Workings
- (IBAction)calcExerLbs:(id)sender {
    ...
    if ( [_stonesField.text length] == 0 || [_stonesField.text isEqualToString:@"."] ) {
        ...
        if ( [_lbsField.text length] == 0 || [_lbsField.text isEqualToString:@"."] ) {
            ...
            if ( [_timeField.text length] == 0 || [_timeField.text isEqualToString:@"."] ) {
                ...
                lowValue = 0.073392817;
                medValue = 0.102374383;
                highValue = 0.254580857;
...
//Metric Workings
- (IBAction)calcExerKgs:(id)sender {
