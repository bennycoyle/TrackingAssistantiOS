...
#import "smartPointsiPad.h"
#import "ThreeCelliPad.h"
#import "commonFunctions.h"

@interface smartPointsiPad (){
    commonFunctions *cf;
}
...
@implementation smartPointsiPad {
...
- (void)viewDidLoad
{
    ...
    NSString *filePathOne = [[NSBundle mainBundle] pathForResource:@"smartpointslist"
                                                            ofType:@"bc" ];
    ...
    if (filePathOne != nil) {
        ...
        NSLog(@"XCODE: smartPointsiPad.m line 58. File is empty.. Something has gone wrong");
    }
