...
#import "foodListiPad.h"
#import "ThreeCelliPad.h"
#import "commonFunctions.h"

@interface foodListiPad (){
    commonFunctions *cf;
}
...
- (void)viewDidLoad
{
    ...
    NSString *filePathOne = [[NSBundle mainBundle] pathForResource:@"pointslist"
                                                            ofType:@"bc" ];
    ...
    if (filePathOne != nil) {
        ...
        NSLog(@"XCODE: foodListiPad.m line 58. File is empty.. Something has gone wrong");
    }
