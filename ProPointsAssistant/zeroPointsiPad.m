...
//  TrackingAssistant
//
//  Created by Brendan Coyle on 11/01/2018.
//  Copyright © 2018 Brendan Coyle. All rights reserved.
//


#import "zeroPointsiPad.h"
#import "OneCelliPhone.h"

@interface zeroPointsiPad ()

@end

@implementation zeroPointsiPad {
...
- (void)viewDidLoad
{
    ...
    NSString *filePathOne = [[NSBundle mainBundle] pathForResource:@"zeropoint"
                                                            ofType:@"bc" ];
    ...
    if (filePathOne != nil) {
        ...
        NSLog(@"XCODE: noCountiPad.m line 46. File is empty.. Something has gone wrong");
    }
}
