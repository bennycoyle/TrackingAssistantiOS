...
#import "blueZeroSPiPad.h"
#import "OneCelliPhone.h"

@interface blueZeroSPiPad ()

@end

@implementation blueZeroSPiPad {
...
- (void)viewDidLoad
{
    ...
    NSString *filePathOne = [[NSBundle mainBundle] pathForResource:@"bluezero"
                                                            ofType:@"bc" ];
    ...
    if (filePathOne != nil) {
        ...
        NSLog(@"XCODE: blueZeroSPiPad.m line 46. File is empty.. Something has gone wrong");
    }
}
