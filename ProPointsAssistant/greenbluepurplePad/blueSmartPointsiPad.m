...
#import "blueSmartPointsiPad.h"
#import "ThreeCelliPad.h"
#import "commonFunctions.h"

@interface blueSmartPointsiPad (){
    commonFunctions *cf;
}
...
@implementation blueSmartPointsiPad {
...
- (void)viewDidLoad
{
    ...
    NSString *filePathOne = [[NSBundle mainBundle] pathForResource:@"bluesmartpoints"
                                                            ofType:@"bc" ];
    ...
    if (filePathOne != nil) {
        ...
        NSLog(@"XCODE: blueSmartPointsiPad.m line 58. File is empty.. Something has gone wrong");
    }
