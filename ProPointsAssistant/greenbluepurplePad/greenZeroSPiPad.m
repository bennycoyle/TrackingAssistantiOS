...
#import "greenZeroSPiPad.h"
#import "OneCelliPhone.h"

@interface greenZeroSPiPad ()

@end

@implementation greenZeroSPiPad {
...
- (void)viewDidLoad
{
    ...
    NSString *filePathOne = [[NSBundle mainBundle] pathForResource:@"greenzero"
                                                            ofType:@"bc" ];
    ...
    if (filePathOne != nil) {
        ...
        NSLog(@"XCODE: greenZeroSPiPad.m line 46. File is empty.. Something has gone wrong");
    }
}
