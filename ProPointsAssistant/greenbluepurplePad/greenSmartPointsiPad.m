...
#import "greenSmartPointsiPad.h"
#import "ThreeCelliPad.h"
#import "commonFunctions.h"

@interface greenSmartPointsiPad (){
    commonFunctions *cf;
}
...
@implementation greenSmartPointsiPad {
...
- (void)viewDidLoad
{
    ...
    NSString *filePathOne = [[NSBundle mainBundle] pathForResource:@"greensmartpoints"
                                                            ofType:@"bc" ];
    ...
    if (filePathOne != nil) {
        ...
        NSLog(@"XCODE: greenSmartPointsiPad.m line 58. File is empty.. Something has gone wrong");
    }
