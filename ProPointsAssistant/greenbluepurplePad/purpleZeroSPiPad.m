...
#import "purpleZeroSPiPad.h"
#import "OneCelliPhone.h"

@interface purpleZeroSPiPad ()

@end

@implementation purpleZeroSPiPad {
...
- (void)viewDidLoad
{
    ...
    if (filePathOne != nil) {
        ...
        NSLog(@"XCODE: purpleZeroSPiPad.m line 46. File is empty.. Something has gone wrong");
    }
}
